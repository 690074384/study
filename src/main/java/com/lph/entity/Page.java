...
public class Page {
    ...
    public String getPageStr() {
        ...
        if (totalResult > 0) {
            ...
            if (currentPage == 1) {
                sb.append("	<li><a>共<font color=red>");
                sb.append(totalResult);
                sb.append("</font>条</a></li>\n");
            ...
            for (int i = startTag; i <= totalPage && i <= endTag; i++) {
                if (currentPage == i) {
                    sb.append("<li class=\"active\"><a><font color='white'>").append(i).append("</font></a></li>\n");
                } else {
                    sb.append("	<li style=\"cursor:pointer;\"><a onclick=\"nextPage(").append(i).append(")\">").append(i).append("</a></li>\n");
                }
            }
            ...
            sb.append("		if(url.indexOf('?')>-1){url += \"&").append(entityOrField ? "currentPage" : "page.currentPage").append("=\";}\n");
            sb.append("		else{url += \"?").append(entityOrField ? "currentPage" : "page.currentPage").append("=\";}\n");
            sb.append("		url = url + page + \"&").append(entityOrField ? "showCount" : "page.showCount").append("=").append(showCount).append("\";\n");
            ...
            sb.append("			}else{\n");
            sb.append("				url += \"&").append(entityOrField ? "currentPage" : "page.currentPage").append("=\";\n");
            sb.append("			}\n");
            sb.append("		}else{url += \"?").append(entityOrField ? "currentPage" : "page.currentPage").append("=\";}\n");
            sb.append("		url = url + page + \"&").append(entityOrField ? "showCount" : "page.showCount").append("=").append(showCount).append("\";\n");
            ...
            sb.append("		if(url.indexOf('?')>-1){url += \"&").append(entityOrField ? "currentPage" : "page.currentPage").append("=\";}\n");
            sb.append("		else{url += \"?").append(entityOrField ? "currentPage" : "page.currentPage").append("=\";}\n");
            sb.append("		url = url + \"1&").append(entityOrField ? "showCount" : "page.showCount").append("=\"+value;\n");
            sb.append("		document.forms[0].action = url;\n");
            sb.append("		document.forms[0].submit();\n");
            sb.append("	}else{\n");
            sb.append("		var url = document.location+'';\n");
            ...
            sb.append("				url = url.replace(reg,'currentPage=');\n");
            sb.append("			}else{\n");
            sb.append("				url += \"1&").append(entityOrField ? "currentPage" : "page.currentPage").append("=\";\n");
            sb.append("			}\n");
            sb.append("		}else{url += \"?").append(entityOrField ? "currentPage" : "page.currentPage").append("=\";}\n");
            sb.append("		url = url + \"&").append(entityOrField ? "showCount" : "page.showCount").append("=\"+value;\n");
            sb.append("		document.location = url;\n");
            sb.append("	}\n");
            sb.append("}\n");
