...
import com.lph.util.DateUtil;
import com.lph.util.DelAllFile;
import com.lph.util.FileDownload;
import com.lph.util.FileZip;
import com.lph.util.Freemarker;
...
public class CreateCodeController extends BaseController {
	...
	public void save(PageData pd) throws Exception{
		...
		pd.put("TABLENAME", pd.getString("tabletop")+",lph,"+pd.getString("objectName").toUpperCase());	//表名
